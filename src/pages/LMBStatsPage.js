    ...
    useEffect(() => {
        const getData = async () => {
            try {
                ...
                let averageBattingValue = getBattingAverageX(actualData.data, battingStat)
                ...
                let bottomPitchingObj = getPitchingBottomX(actualData2.data, pitchingStat)
                setMinPitching(bottomPitchingObj)


                let averagePitchingValue = getPitchingAverageX(actualData2.data, pitchingStat)
    ...
    return (
        <>
                                ...
                                <div className="level is-mobile">
                                    ...
                                    <div className="level-item has-widget-icon">
                                        <div className="is-widget-icon"><span
                                            ...
                                            <FcBullish
                                                className="is-size-1"/></span> {/*revisar si se cambian los iconos de maximo y minimo */}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div className="level-item">
                                        <div className="is-widget-label"><p className="subtitle is-spaced">
                                            ...
                                            <span className="title has-text-info">
                                                {(loading && loading) || Math.round((avgBatting + Number.EPSILON) * 100) / 100}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="level-item has-widget-icon">
                                    ...
                                    <div className="level-item">
                                        ...
                                        <div className="is-widget-label"><p className="subtitle is-spaced">
                                            ...
                                            <span className="title has-text-danger-dark">
                                                {(loading && loading) || <p> {minBatting[battingStat]} {minBatting.team} </p>}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="level-item has-widget-icon">
            ...
            <section className="section">
                ...
                <div className="select is-rounded">
                    <select defaultValue={pitchingStat} onChange={handlePitchingStatChange}>
                        <option defaultValue value="ERA">ERA</option>
                        {/*revisar animacion de la grafica*/}
                                    ...
                                    <div className="level-item">
                                        <div className="is-widget-label"><p className="subtitle is-spaced">
                                            ...
                                            <span className="title has-text-success-dark">
                                                ...
                                                {(loading && loading) || <p> {maxPitching[pitchingStat]} {maxPitching.team} </p>}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="level-item has-widget-icon">
                                ...
                                <div className="level is-mobile">
                                    <div className="level-item">
                                        <div className="is-widget-label"><p className="subtitle is-spaced">
                                            ...
                                            <span className="title has-text-info">
                                                {(loading && loading) || Math.round((avgPitching + Number.EPSILON) * 100) / 100}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="level-item has-widget-icon">
                                ...
                                <div className="level is-mobile">
                                    ...
                                    <div className="level-item">
                                        <div className="is-widget-label"><p className="subtitle is-spaced">
                                            ...
                                            <span className="title has-text-danger-dark">
                                                {(loading && loading) || <p> {minPitching[pitchingStat]} {minPitching.team} </p>}
                                            </span>
                                        </div>
                                    </div>
                                    <div className="level-item has-widget-icon">
